...
void drawGameVictory(void)
{
    ...
    drawSprite(SPRITE_V, TITLE_LETTER_ID + 1, LETTER_XPOS, LETTER_YPOS);
    drawSprite(SPRITE_I, TITLE_LETTER_ID + 2, LETTER_XPOS + 16, LETTER_YPOS);
    drawSprite(SPRITE_C, TITLE_LETTER_ID + 3, LETTER_XPOS + 32, LETTER_YPOS);
    drawSprite(SPRITE_T, TITLE_LETTER_ID + 4, LETTER_XPOS + 48, LETTER_YPOS);
    drawSprite(SPRITE_O, TITLE_LETTER_ID + 5, LETTER_XPOS + 64, LETTER_YPOS);
    drawSprite(SPRITE_R, TITLE_LETTER_ID + 6, LETTER_XPOS + 80, LETTER_YPOS);
    drawSprite(SPRITE_Y, TITLE_LETTER_ID + 7, LETTER_XPOS + 96, LETTER_YPOS);
}
